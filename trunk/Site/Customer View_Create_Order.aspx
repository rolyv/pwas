...
<h1>Create new order</h1><table id="orderHistoryTable">
	<table id="ContactTable" >
		...
		<tr>
			<td align="right">Final Size:</td>
			<td align="left"><input value=""> X <input value=""></td>
		</tr>
		<tr>
			<td align="right">Qty. to print:</td>
			<td align="left"><input value=""></td>
		</tr>
		<tr>
...
<br /> <button>Create & Pay</button><button>Clear</button>
</div>
<div class="clear"></div>
</div>
