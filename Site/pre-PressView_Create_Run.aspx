...
<h1>Create Run</h1><table id="orderHistoryTable">
	<table id="ContactTable" >
		<tr>
			<td align="right">Run ID:</td>
			<td align="left"><input value=""></td>
		</tr>
		
		<tr>
			<td align="right">Run Size:</td>
			<td align="left"><input value="23"> X <input value="29"></td>
		</tr>
		<tr>
			<td align="right">Run Qty:</td>
			<td align="left"><input value="500"></td>
		</tr>
		<tr>
			<td align="right">Stock Finish:</td>
			<td align="left"><select><option>Glossy</option></select></td>
		</tr>
		<tr>
			<td align="right">Stock Weight</td>
			<td align="left"><select><option>Heavy</option></select></td>
		</tr>
	</table>
<br /> <button>Create Run</button><button>Clear</button>
</div>
<div class="clear"></div>
</div>
